...
function displayToc(a){
	...
	if(l==postTitle.length){
		var f='<span class="toc-note">Showing All '+postTitle.length+" Article<br/></span>"
	}
	else
		{
		var f='<span class="toc-note">Displays '+l+" articles by category '";
		f+=postFilter+"' from "+postTitle.length+" Count Articles<br/></span>"
	}
...
function hideToc(){
	...
	b.innerHTML='<a href="#" onclick="scroll(0,0);showToc();Effect.toggle(\'toc-result\',\'blind\');">?? Featuring Contents</a> <img src="https://sites.google.com/site/radiorodja2/new_1.gif"/>'
}
function looptemp2(){
